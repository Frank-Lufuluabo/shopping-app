            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-wrap justify-between items-center">
                    ...
                    <div className="w-full sm:w-auto mb-2 sm:mb-0 text-sm">
                        <Link href="" className="hover:opacity-50 mr-4">About Us</Link>
                        <Link href="" className="hover:opacity-50 mr-4">Contact Us</Link>
                        <Link href="" className="hover:opacity-50">Privacy Policy</Link>
                    </div>
                ...
                {/* Copyright */}
                <div className="text-center mt-4 border-t border-blue-400 pt-2 text-xs">
                    <p>&copy; {new Date().getFullYear()} Shop Frank Lufuluabo. All Rights Reserved.</p>
                </div>
            </div>
        </footer>
    );
